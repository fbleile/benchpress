...
def _evaluation(algorithm_ids: list[str], prefix: str) -> dict:
    return {
        ...
        # Algorithms may internally emit DAGs.  Benchpress performs the one
        # canonical DAG->CPDAG conversion before metrics and plots consume the
        # estimate; raw algorithm output remains available as graph_type=original.
